...
handlebarsSinglePartial
  = "{{>" space* partialName:word space* params:(namedParams)? space* "}}"
      {
          return {
              type: 'handlebars',
...
namedParams
  = p:namedParam space* ps:namedParams
    {
      return p.concat(ps);
    }
  / namedParam
...
attributeHandlebarsBlock
  ...
  / attributeHandlebarsBlockPARTIAL
...
//@class UnlessBlockHandlebarsAttributeASTNode @extends BlockHandlebarsAttributeASTNode
attributeHandlebarsBlockPARTIAL
  = '{{#>' space* partialName:word space* params:(namedParams)? space* "}}" ignorable* l:(itemList)? ignorable* "{{/" closeName:word "}}"
    {
      return {
        type: 'handlebars',
